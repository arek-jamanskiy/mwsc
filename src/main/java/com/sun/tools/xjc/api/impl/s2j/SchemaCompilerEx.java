...
/**
 *     Adapted by bulldog, 
 *     to make outline visible to outside
 */
 ...
 *     
 */
public final class SchemaCompilerEx extends ErrorReceiver implements SchemaCompiler {
    ...
    private Outline context;
    
    //make outline visible to outside
...
//            return null;
    ...
    static {
        try {
            NO_CORRECTNESS_CHECK = Boolean.getBoolean(SchemaCompilerEx.class+".noCorrectnessCheck");
        } catch( Throwable t) {
            // ignore
        }
    }
